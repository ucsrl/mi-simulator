...
public class AndNot extends Command {
     ...
     */
    public AndNot(int line, int adress, int length, Operand op1, Operand op2, int beg,
                  int end) {
     ...
     *            the end
     */
    public AndNot(int line, int adress, int length, Operand op1, Operand op2, Operand op3,
                  int beg, int end) {
