...
public class Mult extends Command {
     ...
     */
    public Mult(int line, int adress, int length, Operand op1, Operand op2, int beg, int end,
                boolean floating) {
     ...
     * @param floating true, falls es ein Gleitpunktzahlbefehl ist
     */
    public Mult(int line, int adress, int length, Operand op1, Operand op2, Operand op3,
