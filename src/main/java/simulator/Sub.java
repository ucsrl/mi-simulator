...
public class Sub extends Command {
     ...
     */
    public Sub(int line, int adress, int length, Operand op1, Operand op2, int beg, int end,
               boolean floating) {
     ...
     * @param floating true, falls es ein Gleitpunktzahlbefehl ist
     */
    public Sub(int line, int adress, int length, Operand op1, Operand op2, Operand op3, int beg,
