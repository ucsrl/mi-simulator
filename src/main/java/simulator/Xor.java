...
public class Xor extends Command {
     ...
     */
    public Xor(int line, int adress, int length, Operand op1, Operand op2, int beg, int end) {
     ...
     *            Zeichenposition - Ende des Befehlswortes im Quelltext
     */
    public Xor(int line, int adress, int length, Operand op1, Operand op2, Operand op3, int beg,
               int end) {
