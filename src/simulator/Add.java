...
public class Add extends Command {
     ...
     *            true, falls es ein Gleitpunktzahlbefehl ist
     */
    public Add(int line, int adress, int length, Operand op1, Operand op2,
	...
	case 2:
	    ...
	    break;
	case 4:
	    opcode = three ? (floating ? new MyByte("C7") : new MyByte("C6"))
	...
	if (floating) {
		...
		erg[i] = carry ? new MyByte(ope1[i].getContent()
			+ ope2[i].getContent() + 1) : new MyByte(
			ope1[i].getContent() + ope2[i].getContent());
	...
	return "ADD " + bhwfd + " " + op1.toString() + ", " + op2.toString()
		+ (three ? ", " + op3.toString() : "");
    }
