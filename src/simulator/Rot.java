...
public class Rot extends Command {
     ...
     */
    public Rot(int line, int adress, Operand op1, Operand op2, Operand op3,
	    int beg, int end) {
	...
	MyByte[] erg = NumberConversion.intToByte(
		ope1 < 0 ? Integer.rotateRight(
			NumberConversion.myBytetoIntWithSign(ope2), -ope1)
			: Integer.rotateLeft(
				NumberConversion.myBytetoIntWithSign(ope2),
				ope1), 4);
	...
	return "ROT " + op1.toString() + ", " + op2.toString() + ", "
		+ op3.toString();
    }
