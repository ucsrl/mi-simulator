...
public class Mult extends Command {
     ...
     *            true, falls es ein Gleitpunktzahlbefehl ist
     */
    public Mult(int line, int adress, int length, Operand op1, Operand op2,
	...
	case 2:
	    ...
	    break;
	case 4:
	    opcode = three ? (floating ? new MyByte("DB") : new MyByte("DA"))
	...
	return "MULT " + bhwfd + " " + op1.toString() + ", " + op2.toString()
		+ (three ? ", " + op3.toString() : "");
    }
