...
public class Sh extends Command {
     ...
     */
    public Sh(int line, int adress, Operand op1, Operand op2, Operand op3,
	    int beg, int end) {
	...
	MyByte[] erg = NumberConversion.intToByte(
		ope1 < 0 ? NumberConversion.myBytetoIntWithSign(ope2) >>> -ope1
	...
	return "SH " + op1.toString() + ", " + op2.toString() + ", "
		+ op3.toString();
    }
