...
public class Sub extends Command {
     ...
     *            true, falls es ein Gleitpunktzahlbefehl ist
     */
    public Sub(int line, int adress, int length, Operand op1, Operand op2,
	...
	case 2:
	    ...
	    break;
	case 4:
	    opcode = three ? (floating ? new MyByte("D1") : new MyByte("D0"))
	...
	if (floating) {
		...
		erg[i] = carry ? new MyByte(ope2[i].getContent()
			+ ope1[i].negate().getContent() + 1) : new MyByte(
	    ...
	    Enviroment.flags.setZero(erg1 == 0);

	    Enviroment.flags.setNegative(erg1 < 0);
	...
	return "SUB " + bhwfd + " " + op1.toString() + ", " + op2.toString()
		+ (three ? ", " + op3.toString() : "");
    }
