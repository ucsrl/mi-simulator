...
public class AbsAddress implements Operand, AdressGetter {
     ...
     * 
     * @param name
     *            Labelname des Operanden
     * @param length
     *            Länge des Operanden
     * @param ort
     *            Speicherstelle des Operanden
     * @param offset
     *            Offset des Operanden
     */
	...
	if (hasLabel()) {
	    return new RelAddressing(adress - ort + offset - 1,
		    CONSTANTS.PC_REGISTER, length, ort).getOpCode();
	}
     ...
     * 
     * @param adr
     *            Speicherstelle auf die der Operand zeigen soll
     */
	...
	return Integer.toString(getAdress())
		+ (offset != 0 ? Integer.toString(offset) : "");
    }
