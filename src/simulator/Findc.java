...
public class Findc extends Command {
     ...
     */
    public Findc(int line, int adress, Operand op1, Operand op2, Operand op3,
	...
	int zahl = string.indexOf("0") == -1 ? p + s : string.indexOf("0");
	...
	return "FINDC " + op1.toString() + ", " + op2.toString() + ", "
